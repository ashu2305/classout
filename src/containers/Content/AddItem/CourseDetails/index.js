...
class CourseDetails extends Component{
    constructor(props){
        ...
        this.state={
            ...
            language:props.contentData['language']['id'],
            level:props.contentData['level']['id'],
            category:props.contentData['category']['id'],
            subCategory:props.contentData['subCategory']['id'],
    ...
    componentWillReceiveProps(nextProps){
        let formData = this.state.formData;
         formData={
            ...
            language:nextProps.contentData['language']['id'],
            level:nextProps.contentData['level']['id'],
            category:nextProps.contentData['category']['id'],
            subCategory:nextProps.contentData['subCategory']['id'],
                    ...
                    <div className="col-md-8">
                            ...
                            <div className="col-md-6 catagories-dropdowns">
                                <div className="field-group select-group">
                                    ...
                                    <Select 
                                        ...
                                        onChange={(e)=>{this.changeHandler(e?e.value:'','language')}}                                        
                                    />
                                </div>
                            </div>
                            <div className="col-md-6 catagories-dropdowns">
                                <div className="field-group select-group">
                                    ...
                                    <Select 
                                       ...
                                       value={this.getDefault(this.state.levels,this.state.formData.level)}
                                        ...
                                        onChange={(e)=>{this.changeHandler(e?e.value:'','level')}}
                                    />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="field-group radio-group">
                            ...
                            <span>
                                ...
                                name="radio-group"
                                value="yes"
                                checked={this.state.formData.isLive}
                                  />
                                <label onClick={(e)=>{                                    
                                    this.changeHandler(true,'isLive')
                                }} htmlFor="test1">Yes</label>
                            </span>
                            <span>
                                <input
                                value="no"                                
                                ...
                                name="radio-group" />
                                <label onClick={(e)=>{                                    
                                    this.changeHandler(false,'isLive')
                                }} 
                                htmlFor="test2">No</label>
                            </span>
                        </div>
                        {
                            this.state.formData.isLive &&
                            <div className="row">
                            <div className="col-md-6 catagories-dropdowns">

...
class UploadPresentation extends Component{
    constructor(props){
        ...
        this.addedPresentation={
            id:'',
            name:'',
            path:''
        }        
    }
    addPresentation = (id,name,path)=>{
        this.addedPresentation={
            id:id,
            name:name,
            path:path
        }  
        this.props.addPresentationFromLibrary(this.addedPresentation)
    }
    ...
    renderResources = ()=>{
        ...
        return filteredList.map((elem,index)=>{
              return (
                <tr key={'presentation-'+elem.id}>
                <td>{elem.name}</td>
                <td>Video</td>
                <td>24/Jan/2020</td>
                <td onClick={()=>this.addPresentation(elem.id,elem.name,elem.path)}><span>Add</span></td>
            </tr>
              )
        })
    }
                    ...
                    <div className="content-block">
                        {
                            ...
                            <div className="video-upload">
                                ...
                                <div className="upload-file">
                                    ...
                                    <input type="file" onChange={(e)=>this.props.uploadPresentation(e)}/>
                                </div>
                            </div>
                        }
                        {
